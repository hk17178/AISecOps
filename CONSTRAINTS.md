...
### C-15. 视觉权威是 V2 文字版架构
设计冲突时一律以 [`docs/architecture-v2.md`](docs/architecture-v2.md) 为准（含 ASCII 图）。
V1 PNG (`docs/architecture.png`) 已被 V2 取代，**禁止再据此设计**。详见 [ADR-0002](docs/adr/0002-architecture-v2-supersedes-png.md)。
要改架构 → 先改 V2 文字版 + 写 ADR → 再改代码。
